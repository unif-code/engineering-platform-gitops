...
| Storage | local-path-provisioner | `v0.0.31` | `docker.io/rancher/local-path-provisioner` | amd64 `sha256:5fb0394abf87407a27cc56db94334eb0c92d0b5de2636683a7ec51f38143dfc9` | **GAP：实施计划指定 local-path，但它不提供架构要求的在线扩容；清单据实设 `allowVolumeExpansion=false`，验收前需登记决策/Deviation** |
...
- [ ] local-path 与在线扩容 Contract 的差异已形成正式决策/Deviation。
